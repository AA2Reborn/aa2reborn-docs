...
Download the game from [here](https://download.aa2reborn.com/AA2Reborn_0.5.2_x64-setup.exe) and follow the instructions. 
...
```
Once you have Wine installed, you can download the AppImage from [here](https://download.aa2reborn.com/AA2Reborn_0.5.2_amd64.AppImage).

Then do:
```bash
chmod +x AA2Reborn_0.5.2_amd64.AppImage
./AA2Reborn_0.5.2_amd64.AppImage
```

If you're stuck in 'Checking game files', try to run:
```bash
sudo ./AA2Reborn_0.5.2_amd64.AppImage
```
